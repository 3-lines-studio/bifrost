...
expect_body "missing doc falls back to the root not-found view" 'data-not-found="root"' "/docs/nope"
expect_body "missing doc keeps the docs layout" 'data-layout="docs"' "/docs/nope"
